  ...
  render() {
    ...
    return (
      <ButtonGroup className="train-route-direction">
        <Button onClick={ this.handleClick } id="N" active={ this.state.isActive } outline color="info">N</Button>
        <Button onClick={ this.handleClick } id="S"  active={ !this.state.isActive } outline color="info">S</Button>
      </ButtonGroup>
    );
  }
}
